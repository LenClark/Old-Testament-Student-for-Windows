...
namespace OldTestamentStudent
{
    public class classGlobal
    {
         ...
         *  ---------                                                             * 
         *                                                                        * 
         *  A variable to make the population of the main text page a little more * 
         *    pleasing esthetically. It is only used at startup.                  * 
         *                                                                        *
         *------------------------------------------------------------------------*/

        bool isStartup;
        public bool IsStartup { get => isStartup; set => isStartup = value; }
         ...
         *  ------------------                                                    * 
         *                                                                        * 
         *  This is similar to isStartup (above) and used when text is changed to * 
         *    avoid multiple refreshes.  It can be used at any time in the app.   * 
         *                                                                        *
         *------------------------------------------------------------------------*/

        bool isTextUpdateActive;
        public bool IsTextUpdateActive { get => isTextUpdateActive; set => isTextUpdateActive = value; }
        ...
        String notesPath = "Notes", mtNotesFolder = "MT", lxxNotesFolder = "LXX", mtNotesName = "Default", lxxNotesName = "Default";
        ...
        {
            //            baseDirectory = Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + @"\LFCConsulting\OTStudent\Source";
            ...
            fullLexiconFile = baseDirectory + @"\" + lexiconFile;
            fullGkLexiconFolder = baseDirectory + @"\" + gkLexiconFolder;
            fullGkLexiconFile = fullGkLexiconFolder + @"\" + mainLexFile;
            fullConvertFile = baseDirectory + @"\" + convertFile;
            fullKethibQereFile = baseDirectory + @"\" + kethibQereFile;
            fullCodeFile = baseDirectory + @"\" + codeFile;
            fullHelpFile = baseDirectory + @"\" + helpPath + @"\" + helpFile;
            fullKeyboardFolder = baseDirectory + @"\" + keyboardFolder;
            fullGkAccute = baseDirectory + @"\" + greekControlFolder + @"\" + gkAccute;
            fullGkCircumflex = baseDirectory + @"\" + greekControlFolder + @"\" + gkCircumflex;
            fullGkDiaereses = baseDirectory + @"\" + greekControlFolder + @"\" + gkDiaereses;
            fullGkGrave = baseDirectory + @"\" + greekControlFolder + @"\" + gkGrave;
            fullGkIota = baseDirectory + @"\" + greekControlFolder + @"\" + gkIota;
            fullGkRough = baseDirectory + @"\" + greekControlFolder + @"\" + gkRough;
            fullGkSmooth = baseDirectory + @"\" + greekControlFolder + @"\" + gkSmooth;
            fullGkConv1 = baseDirectory + @"\" + greekControlFolder + @"\" + gkConv1;
            fullGkConv2 = baseDirectory + @"\" + greekControlFolder + @"\" + gkConv2;
            historyMax = 99;
        ...
        /*================================================================================================================================*
         *                                                                                                                                *
         *                                   Last options from text copy                                                                  *
         *                                   ---------------------------                                                                  *
         *                                                                                                                                *
         *                                       MT                                 LXX                                                   *
         *                                                                                                                                *
         *                           Word  Verse  Chapter  Selection    Word  Verse  Chapter  Selection          option Value meaning     *
         *                           ----  -----  -------  ---------    ----  -----  -------  ---------          --------------------     *
         *                                                                                                                                *
         *   copyDestination          0      4       8        12         16     20      24       28                1  Clipboard           *
         *                                                                                                         2  Notes               *
         *                                                                                                                                *
         *   referenceIncluded        1      5       9        13         17     21      25       29                1  Include             *
         *                                                                                                         2  Exclude             *
         *                                                                                                                                *
         *   AccentsIncluded          2      6      10        14         18     22      26       30                1  Include             *
         *                                                                                                         2  Exclude             *
         *                                                                                                                                *
         *   Remember and use settings 3     7      11        15         19     23      27       31                1  Don't use           *
         *                                                                                                         2  Use                 *
         *                                                                                                                                *
         *================================================================================================================================*/
        int noOfCopyOptions = 0;
        SortedList<int, int> copyOptionCollection = new SortedList<int, int>();

        public int NoOfCopyOptions { get => noOfCopyOptions; set => noOfCopyOptions = value; }

        public void setCopyOption(int optionCode, int optionValue)
        {
            if (copyOptionCollection.ContainsKey(optionCode) )
            {
                copyOptionCollection.Remove(optionCode);
            }
            copyOptionCollection.Add(optionCode, optionValue);
        }

        public int getCopyOption(int optionCode)
        {
            int optionValue;

            if( copyOptionCollection.ContainsKey( optionCode))
            {
                copyOptionCollection.TryGetValue(optionCode, out optionValue);
                return optionValue;
            }
            return 0;
        }
