...
namespace OldTestamentStudent
{
    public class classRegistry
    {
        ...
        int defaultSplitPosition, defaultHeight, defaultWidth, defaultX, defaultY;
        String keyString;
        ...
        public void initialiseWindowDetails()
        {
             ...
             *                                                                                   *
             *===================================================================================*/
            String[] windowDetails = { "Window Position X", "Window Position Y", "Window Width", "Window Height", "Main Splitter Distance" };
            ...
            if (regValue == null)
            {
                baseKey.SetValue(windowDetails[4], defaultSplitPosition, RegistryValueKind.DWord);
            }
            else
            {
