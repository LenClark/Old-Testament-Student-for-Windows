...
namespace OldTestamentStudent
{
    class classMTSearchMatches
    {
        ...
        classMTWord primaryScanWord, secondaryScanWord;
        ...
        public classMTWord PrimaryScanWord { get => primaryScanWord; set => primaryScanWord = value; }
        public classMTWord SecondaryScanWord { get => secondaryScanWord; set => secondaryScanWord = value; }
    }
}
