...
namespace OldTestamentStudent
{
    public partial class frmMain : Form
    {
        ...
        private void performInitialisation()
        {
            ...
            globalVars.setCopyOptions(0, 3, 1, 0);
            globalVars.setCopyOptions(1, 3, 1, 0);
            globalVars.setCopyOptions(2, 3, 1, 0);
            globalVars.setCopyOptions(3, 3, 1, 0);
            globalVars.setCopyOptions(0, 3, 1, 1);
            globalVars.setCopyOptions(1, 3, 1, 1);
            globalVars.setCopyOptions(2, 3, 1, 1);
            globalVars.setCopyOptions(3, 3, 1, 1);
...
//            if (cbBook == globalVars.getComboBoxControlByIndex(0)) mtText.respondToNewBook();
        ...
        private void cbChapter_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (cbChapter == (ComboBox) globalVars.getGroupedControl(globalVars.ComboBoxesCode, 1))
            {
                ...
                mtText.displayChapter(bookId, chapterId);
            }
            if (cbChapter == (ComboBox)globalVars.getGroupedControl(globalVars.ComboBoxesCode, 4))
            {
                ...
                lxxText.displayChapter(bookId, chapterId);
            }
        }
...
//                        rtxtMainText.Refresh();
        ...
        {
            int tagVal, versionFlag, idx, rememberCount = 0;
            ToolStripMenuItem currentMenuItem;
            ...
            currentMenuItem = (ToolStripMenuItem)sender;
            tagVal = Convert.ToInt32(currentMenuItem.Tag);
            versionFlag = ((TabControl)globalVars.getGroupedControl(globalVars.TabControlCode, 0)).SelectedIndex;
            copyOptions = new frmCopyOptions(tagVal, versionFlag, globalVars, hebrewLexicon, greekOrthography, notesProcessing);
            optionsReturned = globalVars.getCopyOption(tagVal - 1, versionFlag);
            if (optionsReturned.Item4 == 2)
            {
                copyOptions.DestCode = optionsReturned.Item1;
                copyOptions.RefCode = optionsReturned.Item2;
                copyOptions.AccentCode = optionsReturned.Item3;
                copyOptions.RememberCode = optionsReturned.Item4;
            ...
            if(rememberCount > 0) mnuTextReset.Enabled = true;
            else mnuTextReset.Enabled = false;
        }
        ...
        private void mnuTextReset_Click(object sender, EventArgs e)
        {
            ...
            copyReset.IsMTWordChecked = globalVars.getCopyOption(0, 0).Item4;
            copyReset.IsMTVerseChecked = globalVars.getCopyOption(1, 0).Item4;
            copyReset.IsMTChapterChecked = globalVars.getCopyOption(2, 0).Item4;
            copyReset.IsMTSelectionChecked = globalVars.getCopyOption(3, 0).Item4;
            copyReset.IsLXXWordChecked = globalVars.getCopyOption(0, 1).Item4;
            copyReset.IsLXXVerseChecked = globalVars.getCopyOption(1, 1).Item4;
            copyReset.IsLXXChapterChecked = globalVars.getCopyOption(2, 1).Item4;
            copyReset.IsLXXSelectionChecked = globalVars.getCopyOption(3, 1).Item4;
            ...
            if ( isUseful)
            {
                ...
                {
                    globalVars.setCopyOptions(0, 3, copyReset.IsMTWordChecked, 0);
                    globalVars.setCopyOptions(1, 3, copyReset.IsMTVerseChecked, 0);
                    globalVars.setCopyOptions(2, 3, copyReset.IsMTChapterChecked, 0);
                    globalVars.setCopyOptions(3, 3, copyReset.IsMTSelectionChecked, 0);
                    globalVars.setCopyOptions(0, 3, copyReset.IsLXXWordChecked, 1);
                    globalVars.setCopyOptions(1, 3, copyReset.IsLXXVerseChecked, 1);
                    globalVars.setCopyOptions(2, 3, copyReset.IsLXXChapterChecked, 1);
                    globalVars.setCopyOptions(3, 3, copyReset.IsLXXSelectionChecked, 1);
                    if( copyReset.IsMTWordChecked == 2) rememberCount++;
                    if (copyReset.IsMTVerseChecked == 2) rememberCount++;
                    if (copyReset.IsMTChapterChecked == 2) rememberCount++;
                    if (copyReset.IsMTSelectionChecked == 2) rememberCount++;
                    if (copyReset.IsLXXWordChecked == 2) rememberCount++;
                    if (copyReset.IsLXXVerseChecked == 2) rememberCount++;
                    if (copyReset.IsLXXChapterChecked == 2) rememberCount++;
                    if (copyReset.IsLXXSelectionChecked == 2) rememberCount++;
                    if( rememberCount > 0 ) mnuTextReset.Enabled = true;
                    else mnuTextReset.Enabled = false;
                }
            }
